...
namespace Labs{
	...
	/// <summary>
	/// Сводка для Condition_lab3
	/// </summary>
	public ref class Condition_lab3 : public System::Windows::Forms::Form
	{
	public:
		Condition_lab3(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(339, 394);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(171, 68);
			this->button1->TabIndex = 7;
			this->button1->Text = L"Решить";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Condition_lab3::button1_Click);
			// 
			// label1
			// 
			...
			this->label6->Size = System::Drawing::Size(685, 26);
			this->label6->TabIndex = 14;
			this->label6->Text = L"Также необходимо занести полученные ответы в базу данных Access";
			// 
			// Condition_lab3
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1034, 496);
			...
			this->Name = L"Condition_lab3";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Condition_lab3";
