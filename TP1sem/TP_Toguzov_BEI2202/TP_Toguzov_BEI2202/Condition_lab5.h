...
namespace Labs {
	...
	/// <summary>
	/// Сводка для Condition_lab5
	/// </summary>
	public ref class Condition_lab5 : public System::Windows::Forms::Form
	{
	public:
		Condition_lab5(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(342, 396);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(171, 68);
			this->button1->TabIndex = 11;
			this->button1->Text = L"Решить";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Condition_lab5::button1_Click);
			// 
			// label1
			// 
			...
			this->label4->Size = System::Drawing::Size(623, 26);
			this->label4->TabIndex = 17;
			this->label4->Text = L"и находят первый положительный элемент исходного массива.";
			// 
			// label3
			// 
			...
			this->label3->Size = System::Drawing::Size(798, 26);
			this->label3->TabIndex = 16;
			this->label3->Text = L"чисел. Разработайте две функции, которые проверяют на монотонность массив ";
			// 
			// label2
			// 
			...
			this->label2->Size = System::Drawing::Size(762, 26);
			this->label2->TabIndex = 15;
			this->label2->Text = L"Дан динамический целочисленный массив положительных и отрицательных ";
			// 
			// Condition_lab5
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(891, 496);
			this->Controls->Add(this->label4);
			this->Controls->Add(this->label3);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->label1);
			this->Name = L"Condition_lab5";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Condition_lab5";
