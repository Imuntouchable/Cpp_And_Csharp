...
namespace Labs {
	...
	/// <summary>
	/// Сводка для Condition_lab4
	/// </summary>
	public ref class Condition_lab4 : public System::Windows::Forms::Form
	{
	public:
		Condition_lab4(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Condition_lab4::button1_Click);
			// 
			// label6
			// 
			...
			this->label6->Size = System::Drawing::Size(546, 26);
			this->label6->TabIndex = 19;
			this->label6->Text = L"Также необходимо занести полученные ответы в Word";
			// 
			// label5
			// 
			...
			this->ClientSize = System::Drawing::Size(1010, 493);
			...
			this->Name = L"Condition_lab4";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Condition_lab4";
